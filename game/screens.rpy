...
screen girls_menu:
    ...
    frame background "img/scene/prison.jpg":
            ...
            grid girls_cols 1:
                ...
                for col_i in xrange(girls_cols):
                    ...
                    if girl_i < game.girls_list.prisoners_count:
                        imagebutton idle Image(im.Grayscale(game.girls_list.prisoners[girl_i].avatar)) hover game.girls_list.prisoners[girl_i].avatar action[Function(game.girls_list.set_active, girl_i), Return(True)]
                    else:
                        null
        ...
        hbox:
            ...
            textbutton _("Out") action Return(False)
